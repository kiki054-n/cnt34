...
- **インタラクティブデモ**: [`docs/Governance/Governance-5w1h.html`](06_GOVERNANCE/Governance-5w1h.html) - 膜の誕生と分裂を可視化
...
三四式を人の役割・労働に適用した章です。図解版は [`TTT_4pillars_repository.html`](06_GOVERNANCE/pillars/TTT_4pillars_repository.html) をご覧ください。
...
4. 1分後に https://kiki054-n.github.io/cnt34/ でトップページ（index.html）が公開されます。ガバナンス・デモへは https://kiki054-n.github.io/cnt34/docs/Governance/Governance-5w1h.html から直接アクセスすることもできます。
