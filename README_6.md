...
📄 [紹介ページ（CNT34_TriTetra_Introduction.html）](https://kiki054-n.github.io/cnt34/CNT34_TriTetra_Introduction.html) — 全体像・導出の要点・参加方法を1枚にまとめた紹介ページ
...
- **思想の核**: [`docs/Governance/governance.md`](06_GOVERNANCE/governance.md) - 3権 + 国民主権 + AI = 第5の自律体「検証可能な合意細胞」
- **実装設計図**: [`docs/Governance/5W1H.md`](06_GOVERNANCE/5W1H.md) - 5W1Hで展開する合意細胞の設計
- **インタラクティブデモ**: [`06_GOVERNANCE/Governance-5w1h.html`](https://kiki054-n.github.io/cnt34/06_GOVERNANCE/Governance-5w1h.html) - 膜の誕生と分裂を可視化
...
- [`theory/cell-division.md`](04_LIFE/cell-division.md) - 細胞分裂の幾何学 — メタン分子（5 → 15 → 30 → 15+15）と「2・3・4・5」という数の並びで、理論全体を閉じる
...
- [`docs/pillars/pillar-01-create.md`](06_GOVERNANCE/pillars/pillar-01-create.md) - 第1柱・作る労働
- [`docs/pillars/pillar-02-support.md`](06_GOVERNANCE/pillars/pillar-02-support.md) - 第2柱・支える労働
- [`docs/pillars/pillar-03-govern.md`](06_GOVERNANCE/pillars/pillar-03-govern.md) - 第3柱・管理労働
- [`docs/pillars/pillar-04-invent.md`](06_GOVERNANCE/pillars/pillar-04-invent.md) - 第4柱・創造労働
- [`docs/pillars/gratitude.md`](07_WCCC/gratitude.md) - 感謝の循環プロトコル
...
4. 1分後に https://kiki054-n.github.io/cnt34/ でトップページ（index.html）が公開されます。ガバナンス・デモへは https://kiki054-n.github.io/cnt34/06_GOVERNANCE/Governance-5w1h.html から直接アクセスすることもできます。
